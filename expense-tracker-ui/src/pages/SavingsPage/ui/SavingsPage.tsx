...
import { Goal, GoalsList, getGoalsCompleted, getGoalsIsLoading, fetchGoals, getUserGoals, goalsReducer, getGoalsLimit, getGoalsCurrentPage, goalsActions, getGoalsTotalPages, getGoalsCount } from 'entities/Goal';
