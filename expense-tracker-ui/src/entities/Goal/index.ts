import { getGoalsCompleted, getGoalsIsLoading, getGoalsError, getGoalsCount, getGoalsCurrentPage, getGoalsLimit } from './model/selectors/goal';
...
export { GoalsList };
export { fetchGoals };
export { getGoalsCompleted, getGoalsIsLoading, getGoalsError, getGoalsCount, getGoalsCurrentPage, getGoalsLimit };
